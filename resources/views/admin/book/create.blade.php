              ...
              @csrf
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title"class="form-control" id="exampleInputEmail1" placeholder="Называние книг">
                    <div class="form-group">
                    <label for="exampleInputEmail1">Автор</label>
                    <input type="text" name="author" class="form-control" id="exampleInputEmail2" placeholder="Автор книги">
                  </div>
                </div>
                <!-- /.card-body -->
